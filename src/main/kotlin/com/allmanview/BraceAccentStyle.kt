...
import com.allmanview.scan.BlockCounts
import com.allmanview.scan.BlockKind
import com.allmanview.scan.BraceAccent
import com.allmanview.scan.LabelPolicy
...
class BraceAccentStyle(
    ...
    fun needsLabel(accent: BraceAccent): Boolean {
        ...
        return LabelPolicy.needsLabel(
            ...
            nestedLabelMinLines = settings.state.nestedMarkerEndOfBlockMinLines,
     ...
     * quiet together. On the declaration line this is unconditional; on the closing brace it
     * additionally answers to [AllmanSettings.Config.nestedMarkerEndOfBlockMinLines] -- see
     * [LabelPolicy.marksAsNested].
     */
    fun marksAsNested(accent: BraceAccent): Boolean {
        return LabelPolicy.marksAsNested(
            accent,
            nestedMarkerEnabled = settings.state.nestedMarkerEnabled,
            endOfBlockMinLines = settings.state.nestedMarkerEndOfBlockMinLines,
        )
    }
